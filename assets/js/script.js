...
document.getElementById('botonForm').addEventListener('click', function(){
  let titulo = document.getElementById('title').value;
  let descripcion = document.getElementById('content').value;
  let atributo = document.getElementById('botonPop').getAttribute('data-bs-content');
   
  atributo.innerHTML = descripcion;

  //document.querySelector('.popover-body').innerHTML = descripcion;


   //document.getElementById('botonPop').setAttribute('data-bs-content', descripcion);
   
   //document.getElementById('botonPop').getAttribute('data-bs-content')
